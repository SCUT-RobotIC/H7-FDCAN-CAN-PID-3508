...
int main(void)
{
  ...
  PID_Angle_A_Para_Init(2, 5 , 0.5 , 0 , 0);
	PID_Angle_S_Para_Init(2, 6 , 70 , 30 , 0.1);
  PID_Angle_A_Para_Init(2, 6 , 0.5 , 0 , 0);
	PID_Angle_S_Para_Init(2, 7 , 70 , 30 , 0.1);
  PID_Angle_A_Para_Init(2, 7 , 0.5 , 0 , 0);
